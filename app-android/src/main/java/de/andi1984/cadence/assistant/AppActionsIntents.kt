 ...
 * spoken "create a list with …" names. Cadence repurposes that one parameter as the quick-add
 * text rather than modelling a list: "Hey Google, create a list in Cadence with buy milk" opens
